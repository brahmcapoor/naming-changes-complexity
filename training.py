...
def show_pair_with_names(window, images):
    """
    Shows the pair of images on the screen with their names, with a 10 second delay between images
    """

    # These next two lines are just a quick way of generating the stimuli and labels
    # in a format that psychopy can present.
